# Generated by Django 4.0.5 on 2023-08-06 23:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='demo.orderstatus')),
                ('status_history', models.ManyToManyField(related_name='status_history', to='demo.orderstatus')),
            ],
        ),
    ]
